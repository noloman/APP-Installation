...
public class BALASTOTELEGESTIONADO {
	...
	public BALASTOTELEGESTIONADO(){}
	
	public BALASTOTELEGESTIONADO(String nombre,String traza,double lat,double longi,double alt,String addr,String idnode,
